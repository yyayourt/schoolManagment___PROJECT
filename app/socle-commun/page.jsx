...
import SocleCommunManager from '../components/pedagogie/SocleCommunManager';
        ...
        <div style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <p style={{ color: '#64748b', margin: 0, fontSize: '0.95rem' }}>
              Évaluation officielle des 8 domaines de compétences du Cycle 4 pour le Diplôme National du Brevet (DNB)
            </p>
          </div>
        </div>
